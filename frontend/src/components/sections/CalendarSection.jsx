  ...
  return (
    <section id="calendario" className="bg-[#FFEDD2] border-b-2">
      ...
      <div className="w-full overflow-hidden leading-none mt-8 -mb-1">
        ...
        >
          <path
            d="M0,0 C150,90 350,-30 500,40 C650,110 850,10 1000,50 C1100,70 1170,40 1200,30 L1200,120 L0,120 Z"
            fill="#0B0089"
            stroke="#69358C"
            strokeWidth="5"
          />
          <path
            d="M0,15 C150,105 350,-15 500,55 C650,125 850,25 1000,65 C1100,85 1170,55 1200,45 L1200,120 L0,120 Z"
            fill="#DB37B4"
            stroke="#69358C"
            strokeWidth="5"
          />
          <path
            d="M0,30 C150,120 350,0 500,70 C650,140 850,40 1000,80 C1100,100 1170,70 1200,60 L1200,120 L0,120 Z"
            fill="#FFFDF6"
            stroke="#69358C"
            strokeWidth="5"
          />
